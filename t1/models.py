...
class conference_journal(models.Model):
	...
	c1_date = models.DateField(max_length=500,blank=True, null=True)
	...
	c2_date = models.DateField(max_length=500,blank=True, null=True)
	...
	c3_date = models.DateField(max_length=500,blank=True, null=True)
	...
	c4_date = models.DateField(max_length=500,blank=True, null=True)
	...
	c5_date = models.DateField(max_length=500,blank=True, null=True)
	...
	c7_date = models.DateField(max_length=500,blank=True, null=True)
	...
	j1_date = models.DateField(max_length=500,blank=True, null=True)
	...
	j2_date = models.DateField(max_length=500,blank=True, null=True)
	...
	j3_date = models.DateField(max_length=500,blank=True, null=True)
	...
	j4_date = models.DateField(max_length=500,blank=True, null=True)
	...
	j5_date = models.DateField(max_length=500,blank=True, null=True)
	...
	j6_date = models.DateField(max_length=500,blank=True, null=True)
	...
	j7_date = models.DateField(max_length=500,blank=True, null=True)
